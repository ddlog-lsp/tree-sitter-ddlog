...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [3] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_PARSE, 0),
  [5] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [7] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_PARSE, 1),
...
extern const TSLanguage *tree_sitter_ddlog_dat(void) {
